      ...
      render() {
        return (
            <div>
                ...
                <Typography variant="h2" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}>  How it Works </Typography>


                <Grid container>
                    <Grid item xs={12} sm={8} md={8}>
                    <Typography variant="h5" align="center" style={{fontFamily: "Chango", color: "#3F3D56", padding: 20}}>  In Short </Typography>

                    <Typography variant="h3" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}>  Modern Development Technology </Typography>
                ...
                <Typography variant="h4" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}> Bergquist Applications uses a <b style={{color: "#24CCFF"}}>React</b> Framework called <b style={{color: "#3F3D56"}}>Next.js</b> </Typography>
                ...
                <Typography variant="h3" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}> which allows for simple integration of everything the app needs  </Typography>

                <div style={{backgroundColor: "#3F3D56"}}>
                <Typography variant="h3" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}>  core packages </Typography>
                ...
                <Typography variant="h3" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}>  and more depending on the application </Typography>
                ...
                <Typography variant="h4" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}> A user interface that matches the brand and business  </Typography>
                <Typography variant="h3" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}> with resposive data visualization   </Typography>
                <Responsive />
                <Typography variant="h3" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}> and full control over all business and payment data  </Typography>

                <div style={{backgroundColor: "#3F3D56"}}>
                <Typography variant="h4" align="center" style={{fontFamily: "Chango", color: "#FF6584", padding: 40}}> With the help of modern development tools  </Typography>
                <Typography variant="h3" align="center" style={{fontFamily: "Chango", color: "#E6E6E6", padding: 40}}> build scalable applications for business marketing and management </Typography>
                <br />
