...
console.log(this.state)
      return (
        ...
        <div style={{paddingTop: 40}}>
          <Button onClick={() => window.open("https://www.algogems.io/gallery/OMHDKCZHDVZWF5WDEUV3T5JVH6UXG2THD26GT62M2VZOWVYN24YAONWUAE/ownedNft")} style={{position: "absolute", width: "100%", top: "30%", left: "auto"}}>
